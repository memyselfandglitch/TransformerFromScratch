...
The notebook also includes diagnostic sweeps for arithmetic intensity, matrix shape comparisons, single-token versus multi-token query operations, and batch size.
